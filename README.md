...
Results suggest **3-5X** improvement in runtimes when comparing GPU runtimes with CPU on images between 1MB - 30MB. The speedup is **8-12X** for very large images (30+ MB).
